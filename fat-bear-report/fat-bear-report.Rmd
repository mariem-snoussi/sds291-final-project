...
A preliminary exploration of our data shows that there is some relationship between winning a round and some of our predictor variables using simple logistic regression. There appears to be positive association between angle to camera and the likelihood of winning a round, bear age and likelihood of winning a round, and number of votes and winning a round.
```{r}
bears %>%
